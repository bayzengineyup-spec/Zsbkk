...
export const BUILDINGS: Record<BuildingType, BuildingDef> = {
  center: {
    ...
    on: 'land', buildTime: 24, maxLevel: 4,
    upgrade: [
  ...
  lumbermill: {
    ...
    on: 'land', buildTime: 22, maxLevel: 3,
  },
  mill: {
    ...
    on: 'land', buildTime: 19, maxLevel: 3,
  },
  bakery: {
